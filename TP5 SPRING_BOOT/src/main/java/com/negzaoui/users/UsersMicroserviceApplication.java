...
import com.negzaoui.users.service.UserService;
...
public class UsersMicroserviceApplication {
	...
	//ajouter les rôles
	  ...
	  userService.saveUser(new User(null,"negzaoui","123",true,null));
	  ...
	  userService.addRoleToUser("negzaoui", "USER");
